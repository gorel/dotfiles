...
local function normal_keymap()
  ...
  local keymap = {
    ...
    b = {
      ...
      ["1"] = { "<Cmd>BufferLineGoToBuffer 1<CR>", "Open buffer 1" },
      ["2"] = { "<Cmd>BufferLineGoToBuffer 2<CR>", "Open buffer 2" },
      ["3"] = { "<Cmd>BufferLineGoToBuffer 3<CR>", "Open buffer 3" },
      ["4"] = { "<Cmd>BufferLineGoToBuffer 4<CR>", "Open buffer 4" },
      ["5"] = { "<Cmd>BufferLineGoToBuffer 5<CR>", "Open buffer 5" },
      ["6"] = { "<Cmd>BufferLineGoToBuffer 6<CR>", "Open buffer 6" },
      ["7"] = { "<Cmd>BufferLineGoToBuffer 7<CR>", "Open buffer 7" },
      ["8"] = { "<Cmd>BufferLineGoToBuffer 8<CR>", "Open buffer 8" },
      ["9"] = { "<Cmd>BufferLineGoToBuffer 9<CR>", "Open buffer 9" },
    },
